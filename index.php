...
<html lang="en">
  <head>
    <title>ALFIRDAUSI | Penginapan Keluarga Muslim
    </title>
    <!-- for-mobile-apps -->
    ...
    <div class="banner-top">
      <div class="social-bnr-agileits">
        <ul class="social-icons3">
          <li>
            <a href="https://www.facebook.com/" class="fa fa-facebook icon-border facebook"> 
            </a>
          </li>
          <li>
            <a href="https://twitter.com/" class="fa fa-twitter icon-border twitter"> 
            </a>
          </li>
          <li>
            <a href="https://plus.google.com/u/0/" class="fa fa-google-plus icon-border googleplus"> 
            </a>
          </li> 
        </ul>
      </div>
      <div class="contact-bnr-w3-agile">
        <ul>
          <li>
            ...
            <a href="mailto:info@example.com">Maniskidul, Jalaksana, Kuningan, Jawa Barat, 45554
            </a>
          </li>
          <li>
          ...
          <div class="navbar-header navbar-left">
            ...
            <h1>
              <a class="navbar-brand" href="index.php">
                ...
                <p class="logo_w3l_agile_caption">Penginapan Keluarga Muslim
                </p>
              </a>
            </h1>
          </div>
