...
<div class="w3l-visitors-agile" >
  <div class="container">
    <h3 class="title-w3-agileits title-black-wthree">Kamar Tipe G
    </h3> 
  </div>
        ...
        <ul class="slides">
          <li>
            ...
            <div class="w3layouts_work_grid_right">
              ...
              <br>
              <ul>
                  <li> 1 Ranjang tingkat dengan ukuran bawah 200 x 200 cm dan atas 200 x 160 cm</li>
                  <li> 2 Springbed ukuran 200 x 200 cm dan atas 200 x 160 cm</li>
