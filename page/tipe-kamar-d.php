...
<div class="w3l-visitors-agile" >
  <div class="container">
    <h3 class="title-w3-agileits title-black-wthree">Kamar Tipe D
    </h3> 
  </div>
        ...
        <ul class="slides">
          <li>
            <div class="w3layouts_work_grid_left">
              <img src="images/tipe-d.jpg" alt=" " class="img-responsive" />
            ...
            <div class="w3layouts_work_grid_right">
              ...
              <br>
              <ul>
                  <li> 2 Ranjang dengan ukuran 200 x 200 cm dan 186 x 140 cm</li>
                  <li> 2 Springbed ukuran 200 x 200 cm dan 186 x 140 cm</li>
