  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5>We know what you love
        </h5>
        <p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Star Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.
        </p>
      </div>
    </div>
  </div>
...
<section class="portfolio-w3ls" id="gallery">
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/ga.jpg" class="swipebox">
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/gc.jpg" class="swipebox">
      <img src="images/gc.jpg" class="img-responsive" alt="/">
      <div class="textbox">
        <h4>Alfirdausi
        </h4>
        <p>
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/gb.jpg" class="swipebox">
      <img src="images/gb.jpg" class="img-responsive" alt="/">
      <div class="textbox">
        <h4>Alfirdausi
        </h4>
        <p>
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/gd.jpg" class="swipebox">
      <img src="images/gd.jpg" class="img-responsive" alt="/">
      <div class="textbox">
        <h4>Alfirdausi
        </h4>
        <p>
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/gh.jpg" class="swipebox">
      <img src="images/gh.jpg" class="img-responsive" alt="/">
      <div class="textbox">
        <h4>Alfirdausi
        </h4>
        <p>
  ...
  <div class="col-md-3 gallery-grid gallery1">
    <a href="images/ge.jpg" class="swipebox">
      <img src="images/ge.jpg" class="img-responsive" alt="/">
      <div class="textbox">
        <h4>Alfirdausi
        </h4>
        <p>
...
<div class="w3l-visitors-agile" >
  <div class="container">
    <h3 class="title-w3-agileits title-black-wthree">Testimoni Tamu
    </h3> 
  </div>
