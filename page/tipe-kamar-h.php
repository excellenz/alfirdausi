...
<div class="w3l-visitors-agile" >
  <div class="container">
    <h3 class="title-w3-agileits title-black-wthree">Kamar Tipe H
    </h3> 
  </div>
        ...
        <ul class="slides">
          <li>
            <div class="w3layouts_work_grid_left">
              <img src="images/tipe-h.jpg" alt=" " class="img-responsive" />
            ...
            <div class="w3layouts_work_grid_right">
              ...
              <br>
              <ul>
                  <li> 1 buah ranjang dengan ukuran 200x200 cm</li>
                  <li> Dua buah springbed dengan ukuran 200 x200 cm dan 200 x 80 cm</li>
                  ...
                  <li> Lokasi di Area HK di Lantai 2</li>
                  <li> Non Breakfast</li>
              </ul>
